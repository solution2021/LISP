;I found this somewhere, works pretty good for me.
...
(defun c:hb () (c:hatchb)) ; this line can be commented out if there is anexisting command called hb
